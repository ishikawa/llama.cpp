...
#define LLAMA_STATE_SEQ_FLAGS_ON_DEVICE 2
    ...
    /// @details Constrains sampled tokens so generated bytes remain valid UTF-8.
    LLAMA_API struct llama_sampler * llama_sampler_init_utf8_constrain(
            const struct llama_vocab * vocab);

    LLAMA_API size_t llama_sampler_utf8_constrain_n_interventions(
