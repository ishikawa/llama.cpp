...
// number of command buffers used to encode a graph, overridable with GGML_METAL_N_CB
// (values above GGML_METAL_MAX_COMMAND_BUFFERS are clamped by ggml_metal_set_n_cb)
